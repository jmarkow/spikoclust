function [WINDOWS TIMES TRIALS CLUSTDATA ISI STATS]=spikoclust_cluster_quality(SPIKEWINS,SPIKETIMES,SPIKEDATA,LABELS,TRIALNUM,MODEL)
%script to check the clustering quality
%
%
%
...
STATS.contamination=spikoclust_cluster_contamination(SPIKEDATA,MODEL);
